...
<div class="container" id="container" style="width: 100%;">   <div class="row clearfix" id="head">
    ...
    <div class="row clearfix" id="body" style="display: flex;flex-direction: row;min-height: 600px">
        <jsp:include page="left.jsp">
            <jsp:param name="navItem" value="rentCar"/>
        </jsp:include>
        <div class="col-md-10 column" id="content"style="background-image:url('${pageContext.request.contextPath}/static/image/kyaru11.gif');background-size: 100%">
            ...
            <div class="row clearfix">
                <div class="col-md-12 column" id="main" style="padding: 0;display: flex;justify-content: center">
                    <form role="form" action="${pageContext.request.contextPath}/doRentCar" method="get" enctype="multipart/form-data"
