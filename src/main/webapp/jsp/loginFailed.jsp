...
<head>
    <title>登录失败</title>
    <meta http-equiv="refresh" content="1;url=${pageContext.request.contextPath}/jsp/login.jsp"/>
</head>
<body>

<p>
    用户没有登录，请登陆后再访问此页面！将在<span id="timespan" style="color: red; font-weight: bold">1</span>秒后跳转到登录页面...
</p>
