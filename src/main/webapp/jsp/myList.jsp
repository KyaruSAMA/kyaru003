                        ...
                        <div class="dropdown-menu pull-right"
                            ...
                            <div class="row" style="margin-left: 15px;margin-right: 15px;margin-top: 10px">
                                <div class="col-md-4 text-center grid" onclick="location.href='${pageContext.request.contextPath}/jsp/myList.jsp';">
                                    ...
                                    <a href="jsp/myList.jsp" style="padding: 0;margin-top: 6px;margin-bottom: 10px;font-size: 12px">
                                        个人中心</a>
                                </div>
            ...
            <div class="row clearfix">
                <div class="col-md-12 column" id="main">
                            ...
                            <td class="table-main">
                                <div>
                                    <img class="img-rounded" id="imagePreview"
                                         src="${pageContext.request.contextPath}/${sessionScope.mUser.imagePath}"
                                         alt="无图片"
                    ...
                    <div style="display: flex;justify-content: center">
                        <a href="${pageContext.request.contextPath}/userUpdate?userId=${sessionScope.mUser.id}" class="btn btn-danger" role="button">修改信息</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="${pageContext.request.contextPath}/loginOut" class="btn btn-danger" role="button">退出登录</a>
                    </div>
                </div>
            </div>
        </div>
